...
export default function QuizEditor({quizData, setParentQuiz}: {quizData: IQuiz, setParentQuiz: any}) {
    ...
    const questions = useSelector((state: QuizState) => state.questionsReducer.questions);
    const selectedQuestion = useSelector((state: QuizState) => state.questionsReducer.question);
