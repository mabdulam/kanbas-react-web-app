    ...
    return (
      <div id="wd-courses-navigation" className="list-group fs-5 rounded-0">
        ...
        <a id="wd-course-modules-link" href="#/Kanbas/Courses/1234/Modules"
           className="list-group-item border border-0 text-danger"> Modules </a>
        <a id="wd-course-piazza-link"  href="#/Kanbas/Courses/1234/Piazza"
           className="list-group-item border border-0 text-danger"> Piazza </a>
        <a id="wd-course-zoom-link"    href="#/Kanbas/Courses/1234/Zoom"
           className="list-group-item border border-0 text-danger"> Zoom </a>
        <a id="wd-course-quizzes-link" href="#/Kanbas/Courses/1234/Assignments"
           className="list-group-item border border-0 text-danger"> Assignments </a>
        <a id="wd-course-assignments-link" href="#/Kanbas/Courses/1234/Quizzes"
           className="list-group-item border border-0 text-danger"> Quizzes </a>
        <a id="wd-course-grades-link"  href="#/Kanbas/Courses/1234/Grades"
           className="list-group-item border border-0 text-danger"> Grades </a>
      </div>
  );}
